    ...
    return (
        <View style={styles.mainContainer}>
            ...
            {uri != "" ?
                ...
                originWhitelist={["*"]}  style={{ flex: 1,width:PAGE_WIDTH, height: PAGE_HEIGHT+50,backgroundColor:BACKGROUND_COLOR,marginBottom:50,marginTop:45 }} onNavigationStateChange={(resp)=>{
