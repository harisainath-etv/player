              ...
              {menuArray.map((singleMenu) => {
                return (
                  <TouchableOpacity
                    onPress={() =>
                      navigation.dispatch(
                        StackActions.replace(singleMenu.navigateTo, {
                          pageFriendlyId: singleMenu.pageFriendlyId,
                        })
                      )
                    }
                    style={styles.menuItem}
                    key={singleMenu.pageName}
                  >
                    {singleMenu.type == 1 ? (
                      <MaterialCommunityIcons
                        name={singleMenu.iconName}
                        size={27}
                        color={
                          pageName == singleMenu.pageName
                            ? MORE_LINK_COLOR
                            : NORMAL_TEXT_COLOR
                        }
                      ></MaterialCommunityIcons>
