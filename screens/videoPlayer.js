...
export default function Video({ navigation }) {
  ...
  const LOCAL_PATH_TO_VIDEO =
    Platform.OS === "ios"
      ? `${RNFS.DocumentDirectoryPath}/5a28f21875627519a3300000.mp4`
      : `${RNFS.ExternalDirectoryPath}/5a28f21875627519a3300000.mp4`;
      ...
      if (Platform.OS === "android") {
        const granted = await PermissionsAndroid.request(
          PermissionsAndroid.PERMISSIONS.WRITE_EXTERNAL_STORAGE,
          {
            ...
            message: "Please give permissions to store the downloaded file.",
            buttonPositive: "OK",
          }
        );
      ...
      <View style={styles.container}>
        ...
        <VideoPlayer
          ...
          playbackCallback={(playbackStatus) => {
            ...
            if (inFullscreen2) setInFullsreen2(inFullscreen2);
          }}
        />
        {!inFullscreen2 ? (
          <View style={styles.bodyContent}>
            ...
            <View style={styles.options}>
              ...
              <View style={styles.singleoption}>
                <MaterialIcons name="watch-later" size={30} color="#566666" />
              </View>
            </View>
          </View>
        ) : (
