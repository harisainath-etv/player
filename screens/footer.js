      ...
      <View style={styles.footerContainer}>
        {pageName == "Home" ? (
          ...
          >
            ...
            />
            <Text style={[styles.footerText, { color: NORMAL_TEXT_COLOR }]}>
              Home
            </Text>
          </TouchableOpacity>
        ) : (
        ...
        <View style={styles.iconContainer}>
          {pageName == "SHORTS" ? (
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.dispatch(
                  StackActions.replace("Shorts", { pageFriendlyId: "channels" })
                )
              }
            >
              <MaterialCommunityIcons
        ...
        <Modal isVisible={isModalVisible} onBackdropPress={toggleModal}>
          <View style={styles.drawerContainer}>
            {devices.map((singleDevice) => {
              return (
                <TouchableOpacity
                  key={singleDevice.friendlyName}
                  onPress={() => {
                    CastSession(singleDevice.deviceId);
                  }}
                  style={{ width: "100%" }}
                >
                  <View style={styles.deviceContainer}>
                    <Text style={styles.devicesList}>
                      {singleDevice.friendlyName}
                    </Text>
                  </View>
                </TouchableOpacity>
              );
        ...
        <Modal isVisible={isModalVisible} onBackdropPress={toggleModal}>
          <View style={styles.drawerContainer}>
            <View style={{ width: "100%" }}>
              <View style={styles.deviceContainer}>
                <Text style={styles.devicesList}>No Devices Available</Text>
              </View>
            </View>
          </View>
        </Modal>
