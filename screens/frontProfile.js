            ...
            {showslider ?
                ...
                <View style={{flex:1}}>
                    <Carousel
                        ...
                        <View>
                        {index==0 ? <Image key={index} style={styles.image} source={require("../assets/images/slide0.jpg")} resizeMode='stretch'/> : ""}
                        {index==1 ? <Image key={index} style={styles.image} source={require("../assets/images/slide1.jpg")} resizeMode='stretch'/> : ""}
                        {index==2 ? <Image key={index} style={styles.image} source={require("../assets/images/slide2.jpg")} resizeMode='stretch'/> : ""}
                        {index==3 ? <Image key={index} style={styles.image} source={require("../assets/images/slide3.jpg")} resizeMode='stretch'/> : ""}
                        {index==4 ? <Image key={index} style={styles.image} source={require("../assets/images/slide4.jpg")} resizeMode='stretch'/> : ""}
                        </View>
                    }
                    />
