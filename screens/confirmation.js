        ...
        <View style={{ backgroundColor: BACKGROUND_COLOR, flex: 1 }}>
            ...
            {activity ?
                <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 50 }}>
                    <Pressable onPress={makepayment} style={{ justifyContent: 'center', alignItems: 'center', backgroundColor: TAB_COLOR, color: NORMAL_TEXT_COLOR, width: 250, padding: 18, borderRadius: 10, marginRight: 20 }}><Text style={{ color: NORMAL_TEXT_COLOR, fontSize: 16 }}>Processing. Please Wait <ActivityIndicator size='small' color={NORMAL_TEXT_COLOR} /></Text></Pressable>
                </View>
