...
export default function Signup({ navigation }) {
  ...
  async function postData(type) {
    ...
    var userId = "";
    {
      type == "email"
        ? (userId = emailMobile)
        : (userId = calling_code + emailMobile);
    }
    //posting data
    axios
      .post(
        FIRETV_BASE_URL + "users",
        {
  ...
  const registerEmailUser = async () => {
    ...
    if (emailMobile.trim() == "") {
      setemailMobileError("Please enter your email.");
      return true;
    ...
    if (confirmpassword.trim() != newpassword.trim()) {
      setconfirmpasswordError("Password Mismatch. Please re-enter");
      return true;
    } else setconfirmpasswordError("");
    if (ValidateEmail(emailMobile)) {
      ...
      if (CheckPassword(newpassword)) {
        ...
        setnewpasswordError(
          "Password should be minimum of 8 digits and it should have at least one lowercase letter, one uppercase letter, one numeric digit, and one special character."
        );
        return true;
      }
    } else {
  ...
  const signUpMobileUser = async () => {
    ...
    axios
      .post(
        FIRETV_BASE_URL_STAGING + "users/signup_otp",
        {
          auth_token: AUTH_TOKEN,
          user: {
  ...
  const registerEmailUserInternational = async () => {
    ...
    if (emailMobile.trim() == "") {
      setemailMobileError("Please enter your email or mobile no.");
      return true;
    } else setemailMobileError("");
    if (newpassword.trim() == "") {
      setnewpasswordError("Please enter new password.");
              ...
              {selected == "mobile" ? (
                <View style={styles.body}>
                  ...
                  >
                    ...
                    <TouchableOpacity
                      onPress={() => navigatetopage("termsCondition")}
                    >
                    ...
                    <TouchableOpacity onPress={() => navigatetopage("privacy")}>
                      <Text style={{ color: NORMAL_TEXT_COLOR, fontSize: 12 }}>
                        {" "}
                        PRIVACY POLICY{" "}
                      </Text>
                    ...
                    <View style={{ flexDirection: "row", width: "100%" }}>
                      ...
                      >
                        <TouchableOpacity onPress={signUpMobileUser}>
                          ...
                          >
                            <Text
                              style={{ color: NORMAL_TEXT_COLOR, fontSize: 16 }}
                            >
                              Next
                            </Text>
                          </LinearGradient>
                      ...
                      >
                        ...
                        >
                          <Text
                            style={{ color: DETAILS_TEXT_COLOR, fontSize: 16 }}
                          >
                            Already a Member?
                          </Text>
                          <Text
              ...
              <View style={styles.body}>
                ...
                >
                  <View style={{ flexDirection: "row", width: "100%" }}>
                    ...
                    >
                      <TouchableOpacity
                        onPress={registerEmailUserInternational}
                      >
                        <LinearGradient
                          useAngle={true}
                          angle={125}
                ...
                >
                  <TouchableOpacity
                    ...
                    style={{ justifyContent: "center", alignItems: "center" }}
                  >
                    <Text style={{ color: DETAILS_TEXT_COLOR, fontSize: 16 }}>
                      Already a Member?
                    </Text>
          ...
          >
            ...
            >
              <TouchableOpacity onPress={() => loadView("privacy")}>
                <Text
                  style={{ color: FOOTER_DEFAULT_TEXT_COLOR, fontSize: 11 }}
                >
                  Privacy Policy
                </Text>
              </TouchableOpacity>
