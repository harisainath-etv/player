...
export const BACKGROUND_TRANSPARENT_COLOR_MENU ="rgba(41, 40, 40, 0.5)";
export const BACKGROUND_TOTAL_TRANSPARENT_COLOR_MENU ="rgba(22, 6, 29, 0)";
export const SIDEBAR_BACKGROUND_COLOR = "#01031A";
export const SLIDER_PAGINATION_SELECTED_COLOR = "#f20c0c";
export const SLIDER_PAGINATION_UNSELECTED_COLOR = "#3a3d68";
export const MORE_LINK_COLOR = "#f20c0c";
export const TAB_COLOR = "#f20c0c";
